...
from utils.utils import get_rich_text, SIZE, FONT_NAME, HEADER_SIZE
import warnings
...
def report(df):
    ...
    with pd.ExcelWriter(f'out/report/{report_filename}', mode=mode, engine='openpyxl') as writer:
...
def freq_table(df):
    ...
    filename_out = f'out/freq/ecopol_freq_table_{today}.xlsx'
    df_big = pd.DataFrame()
...
def report_by_region(df):
    ...
    cols = {
        ...
        'multicolumn': ['Умумий вазият яхшиланмоқдами ёки деярли ўзгармаяптими?', 'Мамлакат ва ислоҳотларга ишонч',
                        'Амалдаги Президентга ишонч', 'Ҳукумат ва Парламент раҳбарларига муносабат','Сиёсий партиялар номзодларига муносабат',
        ...
        for sheet_idx, col in enumerate(columns_):
            if type_ == 'single':
                ...
                if col == 'Умумий вазият яхшиланмоқдами ёки деярли ўзгармаяптими?':
                    columns = ['7.2. Мамлакатдаги умумий вазият',
                               '9. Вилоятдаги умумий вазият',
                               '11. Маҳалладаги умумий вазият']
                ...
                if col == 'Сиёсий партиялар номзодларига муносабат':
                ...
                for col_ in columns:
                    ...
                    col_name = col_.replace(col+'/', '')
                    if col == 'Умумий вазият яхшиланмоқдами ёки деярли ўзгармаяптими?':
                        if col_ == 'Мамлакатдаги умумий вазият':
                        ...
                        if col_ == 'Ўтган икки ой мобайнида Шавкат Мирзиёевга Ўзбекистон Президенти сифатида муносабатингиз ўзгардими?':
                            target_cols = ['Анча яхшиланди', 'Озроқ яхшиланди', 'Ҳеч нарса ўзгармади']
                        elif col_ == 'Шавкат Мирзиёевга ишонасизми?':
                            ...
                            target_cols = ['Аниқ ўзгартира олади', 'Ўзгартиради']
                    ...
                    elif col == 'Сиёсий партиялар номзодларига муносабат':
                        if col_ == 'Шавкат Мирзиёев, Ўзбекистон Либерал-демократик партиясидан президентликка номзод?':
                            target_cols = ['Биламан ва ишонч билан ижобий муносабатда бўламан', 'Биламан, лекин муносабатни баҳолай олмайман']
                        else:
                            target_cols = ['Буни билмайман', 'Биламан ва ишонч билан ижобий муносабатда бўламан', 'Биламан, лекин муносабатни баҳолай олмайман']
                        data = {}
                        for ti, target_col in enumerate(target_cols):
                        ...
                        if col_ == 'Мамлакат ҳаётидаги қизиқарли воқеалар ҳақида асосан қаердан маълумот оласиз?':
                            ...
                            target_cols = ['Телеграм', 'Фейсбук', 'Инстаграм', 'Youtube','Тик-ток', 'Ижтимоий тармоқларда аккаунтим йўқ/ижтимоий тармоқларга кирмайман']
            ...
            if col == 'Илтимос, Шавкат Мирзиёевнинг Президентлик давридаги асосий камчиликларини номлаб беринг?':
                col = '2017-2022 йилларда давлат сиёсатида асосий камчиликларни номлаб беринг?'
            
            if col == 'Илтимос, Шавкат Мирзиёевнинг Президентлик даврида эришган асосий ютуқларини номлаб беринг?':
                col = 'Шавкат Мирзиёевнинг Президентлик даврида эришган асосий ютуқларини номлаб беринг?'
                ...
                for k in range(1, edge_col+1):
                    ...
                    if j == 5:
                        if len(ctab.columns) > 11:
                            if not col in ['Маълумотларнинг асосий манбаси', 'Сиёсий партиялар номзодларига муносабат']:
                        ...
                        if col in ['2017-2022 йилларда давлат сиёсатида асосий камчиликларни номлаб беринг?',
                                     'Сиз яшаб турган ҳудуддаги энг асосий муаммони кўрсатинг:']:
                            thresh = 40
                            lower_thresh = -1
                            ft_high = ft_red
                            ft_low = ft_blue
                        ...
                        if rep_cell.value == 'Республика бўйича':
                            ...
                            rep_vals = [ (worksheet.cell(row=6, column=c_).value, c_)  for c_ in range(1, edge_col+1)][1:]
                            ...
                            rep_cell.font = ft_column
                            rep_vals = [(worksheet.cell(row=7, column=c_).value, c_)  for c_ in range(1, edge_col+1)][1:]
                        ...
                        if not cell.value is None:
                            ...
                            if not isinstance(cell.value, str):
                                ...
                                if cell.value == 'Янги ҳоким керак':
                                    col_highlight.append(k)

                            elif col == 'Вилоят ҳокимларига муносабат':
                                if cell.value in ['Тўлиқ ишонаман', 'Янги ҳоким керак']:
                                    col_highlight.append(k)
                            elif col == 'Парламент сайловларига муносабат':
                                if cell.value == 'Экология партияси':
                                    col_highlight.append(k)
                            elif col == 'Маълумотларнинг асосий манбаси':
                                if cell.value in ['Интернет', 'Телеграм', 'Youtube']:
                                    col_highlight.append(k)
                            elif col == 'Давлат томонидан қуйида келтирилган соҳалардан қай бирида амалга оширилаётган ишларни маъқуллайсиз?':
                                col_highlight.append(7)
                                
                            elif col == 'Қониқиш даражаси':
                                col_highlight.append(3)
                            
                            elif col == 'Умумий вазият яхшиланмоқдами ёки деярли ўзгармаяптими?':
                                if cell.value in ['Яхшиланмоқда']:
                                    col_highlight.append(k)
                            
                            elif col == 'Мамлакат ва ислоҳотларга ишонч':
                                if cell.value in ['Тўлиқ қўшиламан']:
                                    col_highlight.append(k)
                            
                            elif col == 'Ҳукумат ва Парламент раҳбарларига муносабат':
                                if cell.value in ['Биламан ва ишонч билан ижобий муносабатда бўламан']:
                                    col_highlight.append(k)
